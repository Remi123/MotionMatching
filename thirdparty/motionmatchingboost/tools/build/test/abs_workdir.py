...
t = BoostBuild.Tester(["-ffile.jam"], workdir=os.getcwd(), pass_d0=False, pass_toolset=False)
...
try:
    t.run_build_system(status=123, subdir="/must/fail/with/absolute/path", stderr=None)
