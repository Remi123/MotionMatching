...
{
    QGuiApplication app(motionmatchingboost::unit_test::framework::master_test_suite().argc,
                        motionmatchingboost::unit_test::framework::master_test_suite().argv);
    QQuickView view;

    QString fileName(motionmatchingboost::unit_test::framework::master_test_suite().argv[1]);
