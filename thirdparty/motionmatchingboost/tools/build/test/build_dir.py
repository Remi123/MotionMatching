...
t.expect_addition(["build/$toolset/debug*/a.exe", "build/src/$toolset/debug*/b.exe"])
...
t.fail_test(t.stdout().find("warning: the --build-dir option will be ignored") == -1)
...
t.run_build_system(["--build-dir=build"])
t.expect_addition(["build/foo/bin.v2/$toolset/debug*/a.exe", "build/foo/bin.v2/sub/$toolset/debug*/b.exe"])
...
t.fail_test(t.stdout().find("Absolute directory specified via 'build-dir' project attribute") == -1)
