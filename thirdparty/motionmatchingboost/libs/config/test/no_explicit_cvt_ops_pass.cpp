...
#else
namespace motionmatchingboost_no_cxx11_explicit_conversion_operators = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_cxx11_explicit_conversion_operators::test();
}
