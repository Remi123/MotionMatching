...
namespace motionmatchingboost_no_using_template{
...
int test()
{
   motionmatchingboost_no_using_template::op<int, int> a;
   motionmatchingboost_no_using_template::op<int, int> b;
   a+b;
   return motionmatchingboost_no_using_template::global_foo(0);
}
