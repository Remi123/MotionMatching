...
#else
namespace motionmatchingboost_no_explicit_function_template_arguments = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_explicit_function_template_arguments::test();
}
