...
#else
namespace motionmatchingboost_no_cxx11_unified_initialization_syntax = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_cxx11_unified_initialization_syntax::test();
}
