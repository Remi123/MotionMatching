...
#else
namespace motionmatchingboost_no_cxx11_local_class_template_parameters = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_cxx11_local_class_template_parameters::test();
}
