...
#else
namespace motionmatchingboost_no_partial_specialization_implicit_default_args = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_partial_specialization_implicit_default_args::test();
}
