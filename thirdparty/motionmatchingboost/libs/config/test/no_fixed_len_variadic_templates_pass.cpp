...
#else
namespace motionmatchingboost_no_cxx11_fixed_length_variadic_template_expansion_packs = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_cxx11_fixed_length_variadic_template_expansion_packs::test();
}
