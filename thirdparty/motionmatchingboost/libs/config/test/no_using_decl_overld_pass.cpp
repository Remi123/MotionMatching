...
#else
namespace motionmatchingboost_no_using_declaration_overloads_from_typename_base = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_using_declaration_overloads_from_typename_base::test();
}
