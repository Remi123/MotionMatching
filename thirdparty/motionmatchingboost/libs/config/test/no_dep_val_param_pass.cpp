...
#else
namespace motionmatchingboost_no_dependent_types_in_template_value_parameters = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_dependent_types_in_template_value_parameters::test();
}
