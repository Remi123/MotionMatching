...
#else
namespace motionmatchingboost_no_cxx11_function_template_default_args = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_cxx11_function_template_default_args::test();
}
