...
namespace motionmatchingboost_no_cxx17_iterator_traits {
...
int test()
{
    static_assert(has_iterator_category< std::iterator_traits< motionmatchingboost_no_cxx17_iterator_traits::iterator > >::value, "has_iterator_category failed");

    static_assert(!has_iterator_category< std::iterator_traits< motionmatchingboost_no_cxx17_iterator_traits::non_iterator > >::value, "has_iterator_category negative check failed");
