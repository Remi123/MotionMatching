...
#else
namespace motionmatchingboost_no_pointer_to_member_template_parameters = empty_boost;
#endif

int main( int, char *[] )
{
   return motionmatchingboost_no_pointer_to_member_template_parameters::test();
}
