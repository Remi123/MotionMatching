...
namespace motionmatchingboost_no_pointer_to_member_const{
...
int test()
{
   motionmatchingboost_no_pointer_to_member_const::mem_fun(&tester::foo1);
   motionmatchingboost_no_pointer_to_member_const::mem_fun(&tester::foo2);
   return 0;
}
