...
BOOST_WINAPI_IMPORT_EXCEPT_WM motionmatchingboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
...
BOOST_WINAPI_IMPORT motionmatchingboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
GetSystemTimeAsFileTime(::_FILETIME* lpSystemTimeAsFileTime);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM motionmatchingboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
...
BOOST_WINAPI_IMPORT motionmatchingboost::winapi::ULONGLONG_ BOOST_WINAPI_WINAPI_CC
...
{
    motionmatchingboost::winapi::SYSTEMTIME_ st;
    motionmatchingboost::winapi::GetSystemTime(&st);
    motionmatchingboost::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
