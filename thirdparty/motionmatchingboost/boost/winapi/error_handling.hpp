...
BOOST_WINAPI_IMPORT motionmatchingboost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
FormatMessageA(
    motionmatchingboost::winapi::DWORD_ dwFlags,
    motionmatchingboost::winapi::LPCVOID_ lpSource,
    motionmatchingboost::winapi::DWORD_ dwMessageId,
    motionmatchingboost::winapi::DWORD_ dwLanguageId,
    motionmatchingboost::winapi::LPSTR_ lpBuffer,
    motionmatchingboost::winapi::DWORD_ nSize,
    va_list *Arguments);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM motionmatchingboost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
FormatMessageW(
    motionmatchingboost::winapi::DWORD_ dwFlags,
    motionmatchingboost::winapi::LPCVOID_ lpSource,
    motionmatchingboost::winapi::DWORD_ dwMessageId,
    motionmatchingboost::winapi::DWORD_ dwLanguageId,
    motionmatchingboost::winapi::LPWSTR_ lpBuffer,
    motionmatchingboost::winapi::DWORD_ nSize,
    va_list *Arguments);

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_WINAPI_IMPORT motionmatchingboost::winapi::UINT_ BOOST_WINAPI_WINAPI_CC
SetErrorMode(motionmatchingboost::winapi::UINT_ uMode);
#endif
} // extern "C"
#endif
