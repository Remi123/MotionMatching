...
MultiByteToWideChar(
    motionmatchingboost::winapi::UINT_ CodePage,
    motionmatchingboost::winapi::DWORD_ dwFlags,
    motionmatchingboost::winapi::LPCSTR_ lpMultiByteStr,
    int cbMultiByte,
    motionmatchingboost::winapi::LPWSTR_ lpWideCharStr,
    int cchWideChar);
...
WideCharToMultiByte(
    motionmatchingboost::winapi::UINT_ CodePage,
    motionmatchingboost::winapi::DWORD_ dwFlags,
    motionmatchingboost::winapi::LPCWSTR_ lpWideCharStr,
    int cchWideChar,
    motionmatchingboost::winapi::LPSTR_ lpMultiByteStr,
    int cbMultiByte,
    motionmatchingboost::winapi::LPCSTR_ lpDefaultChar,
    motionmatchingboost::winapi::LPBOOL_ lpUsedDefaultChar);
