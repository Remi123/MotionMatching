...
#  define BOOST_FUNCTION_ENABLE_IF_NOT_INTEGRAL(Functor,Type)              \
      typename ::motionmatchingboost::enable_if_<          \
                           !(::motionmatchingboost::is_integral<Functor>::value), \
                           Type>::type
...
namespace motionmatchingboost {
  namespace detail {
    namespace function {
       ...
       * motionmatchingboost::function. It is a union containing function pointers,
      ...
      union function_buffer_members
      {
        ...
        struct type_t {
          ...
          const motionmatchingboost::core::typeinfo* type;
...
# pragma warning(pop)
      ...
      /**
       * Determine if motionmatchingboost::function can use the small-object
       ...
       * motionmatchingboost::function object.
       */
      struct vtable_base
      {
...
public:
  ...
  /** Retrieve the type of the stored function object, or type_id<void>()
      if this is empty. */
  const motionmatchingboost::core::typeinfo& target_type() const
  {
...
#endif
/**
 * The bad_function_call exception class is thrown when a motionmatchingboost::function
 * object is invoked
 */
class BOOST_SYMBOL_VISIBLE bad_function_call : public std::runtime_error
{
public:
  bad_function_call() : std::runtime_error("call to empty motionmatchingboost::function") {}
};
#if defined(BOOST_CLANG)
...
#ifdef BOOST_NO_SFINAE
// Comparisons between motionmatchingboost::function objects and arbitrary function objects
template<typename Functor>
...
#  if !(defined(__GNUC__) && __GNUC__ == 3 && __GNUC_MINOR__ <= 3)
// Comparisons between motionmatchingboost::function objects and arbitrary function
