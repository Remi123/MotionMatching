...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::motionmatchingboost::mpl::aux::yes_tag operator|( \
      ::motionmatchingboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::motionmatchingboost::mpl::aux::no_tag operator|( \
      ::motionmatchingboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::motionmatchingboost::mpl::na) >* \
    ); \
/**/
...
::motionmatchingboost::mpl::aux::yes_tag operator|( \
      ::motionmatchingboost::mpl::aux::has_rebind_tag<int> \
    , ::motionmatchingboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
