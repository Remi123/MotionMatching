...
motionmatchingboost::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
motionmatchingboost::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
motionmatchingboost::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
motionmatchingboost::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
motionmatchingboost::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
motionmatchingboost::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
struct eval_assert {
    ...
    typedef typename ::motionmatchingboost::mpl::if_c<p_type::value,
...
struct eval_assert_not {
    ...
    typedef typename ::motionmatchingboost::mpl::if_c<!p_type::value,
        AUX778076_ASSERT_ARG(assert<false>),
        failed ************ ::motionmatchingboost::mpl::not_<P>::************
    >::type type;
};
...
template< typename Pred >
failed ************ (motionmatchingboost::mpl::not_<Pred>::************
...
template< typename Pred >
typename assert_arg_type< motionmatchingboost::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          motionmatchingboost::mpl::assertion_failed<false>( \
              motionmatchingboost::mpl::make_assert_arg< \
                  typename motionmatchingboost::mpl::eval_assert<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          motionmatchingboost::mpl::assertion_failed<false>( \
              motionmatchingboost::mpl::make_assert_arg< \
                  typename motionmatchingboost::mpl::eval_assert_not<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          motionmatchingboost::mpl::assertion_failed<false>( \
              motionmatchingboost::mpl::assert_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          motionmatchingboost::mpl::assertion<false>::failed( \
              motionmatchingboost::mpl::assert_not_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        motionmatchingboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (motionmatchingboost::mpl::failed ************ ( motionmatchingboost::mpl::assert_relation< \
                  motionmatchingboost::mpl::assert_::relations( sizeof( \
                      motionmatchingboost::mpl::assert_::arg rel motionmatchingboost::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        motionmatchingboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              motionmatchingboost::mpl::assert_rel_arg( motionmatchingboost::mpl::assert_relation< \
                  motionmatchingboost::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        motionmatchingboost::mpl::assertion_failed<(x rel y)>( motionmatchingboost::mpl::assert_rel_arg( \
              motionmatchingboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&motionmatchingboost::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        motionmatchingboost::mpl::assertion_failed<(x rel y)>( (motionmatchingboost::mpl::failed ************ ( \
            motionmatchingboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&motionmatchingboost::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : motionmatchingboost::mpl::assert_ \
{ \
    using motionmatchingboost::mpl::assert_::types; \
    static motionmatchingboost::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        motionmatchingboost::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        motionmatchingboost::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
