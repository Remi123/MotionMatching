...
namespace motionmatchingboost { namespace fusion { namespace detail
{
    ...
    struct static_find_if
    {
        ...
        template <typename Iterator>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        static typename motionmatchingboost::disable_if<traits::is_random_access<Iterator>, type>::type
        ...
        template <typename Iterator>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        static typename motionmatchingboost::enable_if<traits::is_random_access<Iterator>, type>::type
        iter_call(Iterator const& iter)
        {
