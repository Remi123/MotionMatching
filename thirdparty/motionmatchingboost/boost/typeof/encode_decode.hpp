...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace motionmatchingboost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER motionmatchingboost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace motionmatchingboost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER motionmatchingboost::type_of
