...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename motionmatchingboost::type_of::push_back<V, motionmatchingboost::type_of::constant<std::size_t,ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<motionmatchingboost::type_of::constant<std::size_t,ID>, Iter> self_t;\
        typedef motionmatchingboost::type_of::constant<std::size_t,ID> self_id;\
        typedef Iter iter0;\
