...
#define BOOST_TYPEOF_TEMPLATE_PARAM_ENCODE(This, n)\
   typedef typename motionmatchingboost::type_of::encode_template<BOOST_PP_CAT(V, n),\
...
#define BOOST_TYPEOF_TEMPLATE_PARAM_DECODE(This, n)\
   typedef motionmatchingboost::type_of::decode_template< BOOST_PP_CAT(iter, n) > BOOST_PP_CAT(d, n);\
...
#define BOOST_TYPEOF_REGISTER_TYPE_FOR_TEMPLATE_TEMPLATE(Name,Params,ID)\
    ...
    struct encode_template_impl<V,Name<\
        ...
        P)> >\
        : motionmatchingboost::type_of::push_back<V, motionmatchingboost::type_of::constant<std::size_t,ID> >\
    {\
    };\
    template<class Iter> struct decode_template_impl<motionmatchingboost::type_of::constant<std::size_t,ID>, Iter>\
    {\
