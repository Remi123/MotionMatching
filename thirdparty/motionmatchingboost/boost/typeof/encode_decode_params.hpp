...
#define BOOST_TYPEOF_DECODE_PARAM(z, n, text)   \
    typedef motionmatchingboost::type_of::decode_type<iter##n> decode##n;     \
...
#define BOOST_TYPEOF_ENCODE_PARAMS(n, ID)                   \
    ...
    typename motionmatchingboost::type_of::push_back<V, motionmatchingboost::type_of::constant<std::size_t,ID> >::type      \
