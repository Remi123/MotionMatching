...
#define BOOST_TYPEOF_VECTOR(n) BOOST_PP_CAT(motionmatchingboost::type_of::vector, n)

#define BOOST_TYPEOF_sizer_item(z, n, _)\
    char item ## n[V::item ## n ::value];

namespace motionmatchingboost { namespace type_of {
    template<class V>
    struct sizer
    {
...
#define BOOST_TYPEOF_TYPEITEM(z, n, expr)\
    motionmatchingboost::type_of::constant<std::size_t,sizeof(motionmatchingboost::type_of::encode<BOOST_TYPEOF_VECTOR(0)<> >(expr).item ## n)>
...
#define BOOST_TYPEOF(Expr)\
    motionmatchingboost::type_of::decode_begin<BOOST_TYPEOF_ENCODED_VECTOR(Expr) >::type
...
namespace motionmatchingboost { namespace type_of {
    ...
    struct push_back<motionmatchingboost::type_of::offset_vector<V,Offset>,T> {
        typedef offset_vector<V,typename Offset::prior> type;
    };

    template<class V,class T>
    struct push_back<motionmatchingboost::type_of::offset_vector<V,constant<std::size_t,0> >,T> {
        typedef typename push_back<V,T>::type type;
    };
}}

#define BOOST_TYPEOF_NESTED_TYPEITEM(z, n, expr)\
    BOOST_STATIC_CONSTANT(int,BOOST_PP_CAT(value,n) = sizeof(motionmatchingboost::type_of::encode<_typeof_start_vector>(expr).item ## n));\
    typedef motionmatchingboost::type_of::constant<std::size_t,BOOST_PP_CAT(self_t::value,n)> BOOST_PP_CAT(item,n);
...
#define BOOST_TYPEOF_NESTED_TYPEDEF_IMPL(expr) \
        ...
        struct _typeof_encode_fraction {\
            ...
            typedef motionmatchingboost::type_of::offset_vector<BOOST_TYPEOF_VECTOR(0)<>,motionmatchingboost::type_of::constant<std::size_t,self_t::_typeof_encode_offset> > _typeof_start_vector;\
        ...
        struct _typeof_fraction_iter {\
            typedef motionmatchingboost::type_of::generic_typeof_fraction_iter<Pos,_typeof_encode_fraction<0> > self_t;\
...
#define BOOST_TYPEOF_NESTED_TYPEDEF_IMPL(expr) \
        ...
        struct _typeof_fraction_iter {\
            ...
            typedef typename motionmatchingboost::type_of::v_iter<fraction_type,motionmatchingboost::type_of::constant<int,self_t::where> >::type type;\
...
struct BOOST_PP_CAT(_typeof_template_,name) {\
    ...
    typedef typename motionmatchingboost::type_of::decode_type<_typeof_fraction_iter<motionmatchingboost::type_of::constant<std::size_t,0> > >::type type;\
};\
...
# define BOOST_TYPEOF_NESTED_TYPEDEF(name,expr) \
    struct name {\
        BOOST_TYPEOF_NESTED_TYPEDEF_IMPL(expr)\
        typedef motionmatchingboost::type_of::decode_type<_typeof_fraction_iter<motionmatchingboost::type_of::constant<std::size_t,0> > >::type type;\
    };
#endif
