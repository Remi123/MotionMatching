...
//      great as motionmatchingboost::intmax_t can cause some differences to be
...
namespace motionmatchingboost { namespace detail {
  ...
  struct digit_traits<T, false>
  {
      BOOST_STATIC_CONSTANT(int, digits = (
          ...
          - (motionmatchingboost::is_signed<T>::value ? 1 : 0))
          );
  };
#endif

  // Template class integer_traits<Integer> -- traits of various integer types
  // This should probably be rolled into motionmatchingboost::integer_traits one day, but I
      ...
      typedef typename motionmatchingboost::conditional<
        (int(x::is_signed)
          && (!int(x::is_bounded)
             ...
             || (int(x::digits) + 1 >= digit_traits<motionmatchingboost::intmax_t>::digits))),
        Integer,
        ...
        typename motionmatchingboost::conditional<
          ...
          typename motionmatchingboost::conditional<
            ...
            signed long,
            motionmatchingboost::intmax_t
          >::type
        >::type
      >::type difference_type;
#else
      BOOST_STATIC_ASSERT(motionmatchingboost::is_integral<Integer>::value);

      typedef typename motionmatchingboost::conditional<
        (sizeof(Integer) >= sizeof(intmax_t)),

        motionmatchingboost::conditional<
          (motionmatchingboost::is_signed<Integer>::value),
          Integer,
          motionmatchingboost::intmax_t
        >,
