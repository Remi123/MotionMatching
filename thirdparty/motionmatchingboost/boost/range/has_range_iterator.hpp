...
namespace motionmatchingboost
{
    namespace range_detail
    {
        ...
        struct has_range_iterator_impl<
            ...
            BOOST_DEDUCED_TYPENAME ::motionmatchingboost::enable_if<
                BOOST_DEDUCED_TYPENAME mpl::eval_if<is_const<T>,
                    has_type<motionmatchingboost::range_const_iterator<
                                BOOST_DEDUCED_TYPENAME remove_const<T>::type> >,
                    has_type<motionmatchingboost::range_mutable_iterator<T> >
                >::type
            >::type
        >
        ...
        struct has_range_const_iterator_impl<
            T,
            BOOST_DEDUCED_TYPENAME ::motionmatchingboost::enable_if<
                has_type<motionmatchingboost::range_const_iterator<T> >
            >::type
        >
            : motionmatchingboost::mpl::true_
        {
