...
namespace motionmatchingboost
{
    ...
    namespace range
    {
        ...
        inline bool equal( const SinglePassRange1& rng1, const SinglePassRange2& rng2 )
        {
            ...
            return ::motionmatchingboost::range_detail::equal(
                ::motionmatchingboost::begin(rng1), ::motionmatchingboost::end(rng1),
                ::motionmatchingboost::begin(rng2), ::motionmatchingboost::end(rng2) );
        }
    ...
    using ::motionmatchingboost::range::equal;
} // namespace motionmatchingboost
