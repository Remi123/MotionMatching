...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the motionmatchingboost::adaptors::filtered
        // class with a motionmatchingboost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                motionmatchingboost::ignore_unused_variable_warning(i2);
                ...
                motionmatchingboost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME std::iterator_traits<Iterator>::reference r2(*(++i));
                motionmatchingboost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = motionmatchingboost::begin(*m_range);
            iterator i2 = motionmatchingboost::end(*m_range);

            motionmatchingboost::ignore_unused_variable_warning(i1);
            motionmatchingboost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = motionmatchingboost::begin(const_range);
            const_iterator ci2 = motionmatchingboost::end(const_range);

            motionmatchingboost::ignore_unused_variable_warning(ci1);
            motionmatchingboost::ignore_unused_variable_warning(ci2);
        }
