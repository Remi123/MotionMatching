...
namespace motionmatchingboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( motionmatchingboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( motionmatchingboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( motionmatchingboost::begin(l),
                                                 motionmatchingboost::end(l),
                                                 motionmatchingboost::begin(r),
                                                 motionmatchingboost::end(r) );
        }
        ...
        {
            return motionmatchingboost::equal(l, r);
        }
...
incrementable_t test_traversal_tag(motionmatchingboost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(motionmatchingboost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(motionmatchingboost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef motionmatchingboost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef motionmatchingboost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef motionmatchingboost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *motionmatchingboost::prior(this->m_End);
    }
...
public:
    typedef BOOST_DEDUCED_TYPENAME
        motionmatchingboost::mpl::if_<
            motionmatchingboost::mpl::or_<
                motionmatchingboost::is_abstract<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                motionmatchingboost::is_array<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                motionmatchingboost::is_function<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                motionmatchingboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        public:
            ...
            iterator_range(
                ...
                BOOST_DEDUCED_TYPENAME ::motionmatchingboost::enable_if<
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME motionmatchingboost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME motionmatchingboost::enable_if<
            mpl::not_<motionmatchingboost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, motionmatchingboost::next(first, n));
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = motionmatchingboost::begin( r ),
                    new_end   = motionmatchingboost::end( r );
        ...
        */
        ...
        {
            return SeqT( motionmatchingboost::begin( r ), motionmatchingboost::end( r ) );
        }
