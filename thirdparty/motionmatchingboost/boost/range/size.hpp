...
namespace motionmatchingboost
{
    namespace range_detail
    {
        ...
        range_calculate_size(const SinglePassRange& rng)
        {
            return std::distance(motionmatchingboost::begin(rng), motionmatchingboost::end(rng));
        }
    }
...
// but only on the Mac!
        ...
        BOOST_RANGE_CONCEPT_ASSERT((motionmatchingboost::SinglePassRangeConcept<SinglePassRange>));
#endif
