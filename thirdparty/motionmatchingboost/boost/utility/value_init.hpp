...
// Note: The implementation of motionmatchingboost::value_initialized had to deal with the
// fact that various compilers haven't fully implemented value-initialization.
// The constructor of motionmatchingboost::value_initialized<T> works around these compiler
...
#endif
{
  ...
  public :
    ...
    {
      ::motionmatchingboost::swap( this->data(), arg.data() );
    }
