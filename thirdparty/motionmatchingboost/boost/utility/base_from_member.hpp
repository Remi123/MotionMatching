...
struct remove_cv_ref
{
    typedef typename ::motionmatchingboost::remove_cv<typename
     ::motionmatchingboost::remove_reference<T>::type>::type  type;

};  // motionmatchingboost::detail::remove_cv_ref
...
struct is_related
    : public ::motionmatchingboost::is_same<
     typename ::motionmatchingboost::detail::remove_cv_ref<T>::type,
     typename ::motionmatchingboost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::motionmatchingboost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::motionmatchingboost::disable_if< ::motionmatchingboost::detail::is_related<T, U> >
{};
#endif

}  // namespace motionmatchingboost::detail
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::motionmatchingboost::detail::enable_if_unrelated<base_from_member, T...>::type>
...
};  // motionmatchingboost::base_from_member
