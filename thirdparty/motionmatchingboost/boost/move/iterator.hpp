...
class move_iterator
{
   ...
   typedef typename motionmatchingboost::movelib::iterator_traits<iterator_type>::value_type        value_type;
   #if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) || defined(BOOST_MOVE_DOXYGEN_INVOKED)
   typedef value_type &&                                                   reference;
   #else
   typedef typename ::motionmatchingboost::move_detail::if_
      < ::motionmatchingboost::has_move_emulation_enabled<value_type>
      , ::motionmatchingboost::rv<value_type>&
      , value_type & >::type                                               reference;
   #endif
   typedef It                                                              pointer;
   typedef typename motionmatchingboost::movelib::iterator_traits<iterator_type>::difference_type   difference_type;
   typedef typename motionmatchingboost::movelib::iterator_traits<iterator_type>::iterator_category iterator_category;
   ...
   BOOST_MOVE_FORCEINLINE reference operator*() const
   {
      ...
      return *m_it;
      #else
      return ::motionmatchingboost::move(*m_it);
      #endif
   }
   ...
   BOOST_MOVE_FORCEINLINE reference operator[](difference_type n) const
   {
      ...
      return m_it[n];
      #else
      return ::motionmatchingboost::move(m_it[n]);
      #endif
   }
...
template <class I>
struct is_move_iterator< ::motionmatchingboost::move_iterator<I> >
{
...
class back_move_insert_iterator
{
   ...
   { container_m->push_back(motionmatchingboost::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(motionmatchingboost::move(x)); return *this; }
...
class move_insert_iterator
{
   ...
   {
      pos_ = container_m->insert(pos_, ::motionmatchingboost::move(x));
      ++pos_;
      return *this;
   }
