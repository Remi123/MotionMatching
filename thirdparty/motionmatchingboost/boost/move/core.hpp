...
// @endcond
   ...
   class BOOST_RV_ATTRIBUTE_MAY_ALIAS rv
      : public ::motionmatchingboost::move_detail::if_c
         < ::motionmatchingboost::move_detail::is_class<T>::value
         , T
         , ::motionmatchingboost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::motionmatchingboost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::motionmatchingboost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::motionmatchingboost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };

   }  //namespace motionmatchingboost {

   #define BOOST_RV_REF(TYPE)\
      ::motionmatchingboost::rv< TYPE >& \
   //

   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::motionmatchingboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::motionmatchingboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //

   #define BOOST_RV_REF_BEG\
      ::motionmatchingboost::rv<   \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF(TYPE)\
      const ::motionmatchingboost::rv< TYPE >& \
   //

   #define BOOST_COPY_ASSIGN_REF_BEG \
      const ::motionmatchingboost::rv<  \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::motionmatchingboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::motionmatchingboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   BOOST_MOVE_FORCEINLINE typename ::motionmatchingboost::move_detail::enable_if_c
      <  ::motionmatchingboost::move_detail::is_lvalue_reference<Ret>::value ||
        !::motionmatchingboost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::motionmatchingboost::move_detail::enable_if_c
      < !::motionmatchingboost::move_detail::is_lvalue_reference<Ret>::value &&
         ::motionmatchingboost::has_move_emulation_enabled<T>::value
      , ::motionmatchingboost::rv<T>&>::type
         move_return(::motionmatchingboost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }

   template <class T>
   BOOST_MOVE_FORCEINLINE T& unrv(::motionmatchingboost::rv<T> &rv) BOOST_NOEXCEPT
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      motionmatchingboost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::motionmatchingboost::move((BASE_TYPE&)(ARG))
   //

   #define BOOST_MOVE_TO_LV(ARG) \
      ::motionmatchingboost::move_detail::unrv(ARG)
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      BOOST_MOVE_FORCEINLINE operator ::motionmatchingboost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::motionmatchingboost::rv<TYPE>*, this);  }\
      BOOST_MOVE_FORCEINLINE operator const ::motionmatchingboost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::motionmatchingboost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< motionmatchingboost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::motionmatchingboost::move()` due to rvalue reference limitations.
   //!
