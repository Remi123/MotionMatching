...
struct has_trivial_destructor_after_move
   : ::motionmatchingboost::move_detail::is_trivially_destructible<T>
{};

//! By default this traits returns
//! <pre>motionmatchingboost::is_nothrow_move_constructible<T>::value && motionmatchingboost::is_nothrow_move_assignable<T>::value </pre>.
//! Classes with non-throwing move constructor
//! and assignment can specialize this trait to obtain some performance improvements.
template <class T>
struct has_nothrow_move
{
   static const bool value = motionmatchingboost::move_detail::is_nothrow_move_constructible<T>::value &&
                             motionmatchingboost::move_detail::is_nothrow_move_assignable<T>::value;
};
