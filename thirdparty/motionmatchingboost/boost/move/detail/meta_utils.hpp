...
//Forward declare motionmatchingboost::rv
...
struct has_move_emulation_enabled_impl
   : is_convertible< T, ::motionmatchingboost::rv<T>& >
{};
...
template<class T>
struct has_move_emulation_enabled_impl< ::motionmatchingboost::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< motionmatchingboost::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const motionmatchingboost::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::motionmatchingboost::rv<T>& type; };
} // namespace detail_add_rvalue_reference
