...
}} //namespace motionmatchingboost::movelib {
...
#define BOOST_MOVE_STATIC_ASSERT(B) \
         typedef ::motionmatchingboost::move_detail::static_assert_test<\
            (unsigned)sizeof(::motionmatchingboost::move_detail::STATIC_ASSERTION_FAILURE<bool(B)>)>\
