...
{
   typedef typename motionmatchingboost::movelib::detail::first_param<Ptr>::type type;
};
...
{
   typedef typename ::motionmatchingboost::movelib::detail::pointer_element_impl<Ptr>::type type;
};
