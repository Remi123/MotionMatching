...
#  define BOOST_LIB_NAME motionmatchingboost_unit_test_framework
...
namespace motionmatchingboost { namespace unit_test {
...
{
    return ::motionmatchingboost::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
