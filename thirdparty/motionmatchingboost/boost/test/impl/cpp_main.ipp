...
prg_exec_monitor_main( int (*cpp_main)( int argc, char* argv[] ), int argc, char* argv[] )
{
    ...
    BOOST_TEST_I_TRY {
        motionmatchingboost::unit_test::const_string p( std::getenv( "BOOST_TEST_CATCH_SYSTEM_ERRORS" ) );
        ::motionmatchingboost::execution_monitor ex_mon;
        ...
        if( result == 0 )
            result = ::motionmatchingboost::exit_success;
        else if( result != ::motionmatchingboost::exit_success ) {
            std::cout << "\n**** error return code: " << result << std::endl;
            result = ::motionmatchingboost::exit_failure;
        }
    }
    BOOST_TEST_I_CATCH( ::motionmatchingboost::execution_exception, exex ) {
        std::cout << "\n**** exception(" << exex.code() << "): " << exex.what() << std::endl;
        result = ::motionmatchingboost::exit_exception_failure;
    }
    BOOST_TEST_I_CATCH( ::motionmatchingboost::system_error, ex ) {
    ...
    if( result != ::motionmatchingboost::exit_success ) {
        ...
        ::motionmatchingboost::unit_test::const_string p( std::getenv( "BOOST_PRG_MON_CONFIRM" ) );
        if( p != "no" ) {
...
{
    return ::motionmatchingboost::prg_exec_monitor_main( &cpp_main, argc, argv );
}
