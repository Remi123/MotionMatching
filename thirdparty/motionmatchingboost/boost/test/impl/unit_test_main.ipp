...
unit_test_main( init_unit_test_func init_func, int argc, char* argv[] )
{
    ...
    motionmatchingboost::ignore_unused(shutdown_helper);
    ...
    BOOST_TEST_I_TRY {
        ...
        if( list_cont != unit_test::OF_INVALID ) {
            ...
            return motionmatchingboost::exit_success;
        }
        ...
        result_code = !runtime_config::get<bool>( runtime_config::btrt_result_code )
                        ? motionmatchingboost::exit_success
    ...
    BOOST_TEST_I_CATCH( framework::internal_error, ex ) {
        ...
        result_code = motionmatchingboost::exit_exception_failure;
    }
...
main( int argc, char* argv[] )
{
    ...
    motionmatchingboost::unit_test::init_unit_test_func init_func = &init_unit_test;
#else
    extern ::motionmatchingboost::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] );

    motionmatchingboost::unit_test::init_unit_test_func init_func = &init_unit_test_suite;
#endif

    return ::motionmatchingboost::unit_test::unit_test_main( init_func, argc, argv );
}
