...
motionmatchingboost::unit_test::make_test_case( motionmatchingboost::function<void ()>(test_function), \
                                  test_name ,                              \
                                  __FILE__, __LINE__ )
...
motionmatchingboost::unit_test::make_test_case( (test_function),                         \
...
( new motionmatchingboost::unit_test::test_suite( testsuite_name, __FILE__, __LINE__ ) )
...
#define BOOST_AUTO_TEST_SUITE_NO_DECOR( suite_name )                    \
    BOOST_AUTO_TEST_SUITE_WITH_DECOR(                                   \
        suite_name,                                                     \
        motionmatchingboost::unit_test::decorator::collector_t::instance() )          \
/**/
...
BOOST_TEST_DECORATOR( * motionmatchingboost::unit_test::expected_failures( n ) )      \
/**/
...
{                                                                       \
    ...
    motionmatchingboost::unit_test::setup_conditional(t);                             \
    BOOST_TEST_CHECKPOINT('"' << #test_name << "\" test entry");        \
    t.test_method();                                                    \
    BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture teardown");  \
    motionmatchingboost::unit_test::teardown_conditional(t);                          \
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    motionmatchingboost::unit_test::make_test_case(                                   \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( motionmatchingboost::type<TestType>* = 0 )                       \
    {                                                                   \
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture ctor");  \
        ...
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture dtor");  \
                                                                        ...
                                                                        \
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    motionmatchingboost::unit_test::ut_detail::template_test_case_gen<                \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                      \
    motionmatchingboost::unit_test::ut_detail::template_test_case_gen<name,typelist>( \
...
template<typename type_name>                                            \
void BOOST_JOIN( name, _impl )( motionmatchingboost::type<type_name>* );              \
                                                                        \
struct name {                                                           \
    template<typename TestType>                                         \
    static void run( motionmatchingboost::type<TestType>* frwrd = 0 )                 \
    {                                                                   \
...
static motionmatchingboost::unit_test::ut_detail::global_configuration_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static motionmatchingboost::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static motionmatchingboost::unit_test::decorator::collector_t const&                  \
...
namespace motionmatchingboost { namespace unit_test { namespace ut_detail {
...
typedef ::motionmatchingboost::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static motionmatchingboost::unit_test::ut_detail::auto_test_unit_registrar       \
...
static const motionmatchingboost::unit_test::framework::impl::master_test_suite_name_setter mtsetter(BOOST_TEST_STRINGIZE( BOOST_TEST_MODULE ).trim( "\"" ));
#endif

#ifdef BOOST_TEST_ALTERNATIVE_INIT_API
bool init_unit_test()                   {
#else
::motionmatchingboost::unit_test::test_suite*
