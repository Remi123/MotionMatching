...
class base;
typedef motionmatchingboost::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( motionmatchingboost::function<void()> const& setup, motionmatchingboost::function<void()> const& teardown = motionmatchingboost::function<void()>() )
{
...
public:
    typedef motionmatchingboost::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
