...
public:
    ...
    /// @returns
    ///   - @c motionmatchingboost::exit_success on success,
    ///   - @c motionmatchingboost::exit_exception_failure in case test unit
    ///     was aborted for any reason (including uncaught exception)
    ///   - and @c motionmatchingboost::exit_test_failure otherwise
...
/// of the test tree.
///
/// @see motionmatchingboost::unit_test::test_observer
