...
template<typename FPT>
struct fpt_limits : motionmatchingboost::conditional<std::numeric_limits<FPT>::is_specialized,
 ...
 * by the @ref motionmatchingboost::math::fpc::strength given at construction.
 *
 ...
 *
 * Serves the same purpose as motionmatchingboost::math::fpc::close_at_tolerance, but used when one
