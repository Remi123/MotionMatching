...
namespace motionmatchingboost { namespace test_tools { namespace assertion {  \
template<>                                                      \
...
inline
typename motionmatchingboost::enable_if_c<
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<op::EQ<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<op::EQ<L, R> >*, mpl::false_ )
{
    return lhs == rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<op::NE<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<op::NE<L, R> >*, mpl::false_ )
{
    return lhs != rhs;
}
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<OP>*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<op::LT<L, R> >*, mpl::false_ )
{
    return lhs < rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<op::LE<L, R> >*, mpl::false_ )
{
    return lhs <= rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<op::GT<L, R> >*, mpl::false_ )
{
    return lhs > rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, motionmatchingboost::type<op::GE<L, R> >*, mpl::false_ )
{
    return lhs >= rhs;
}
...
template<typename Lhs,typename Rhs>                                 \
struct name<Lhs,Rhs,typename motionmatchingboost::enable_if_c<                    \
...
public:                                                             \
    ...
    {                                                               \
        return assertion::op::compare_collections( lhs, rhs,        \
            (motionmatchingboost::type<elem_op>*)0,                               \
            is_specialized() );                                     \
    }                                                               \
                                                                    \
