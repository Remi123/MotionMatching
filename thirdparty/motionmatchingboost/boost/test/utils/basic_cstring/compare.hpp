...
template<class CharT>
inline bool
operator <( motionmatchingboost::unit_test::basic_cstring<CharT> const& x,
            motionmatchingboost::unit_test::basic_cstring<CharT> const& y )
{
    typedef typename motionmatchingboost::unit_test::basic_cstring<CharT>::traits_type traits_type;
    return x.size() != y.size()
            ? x.size() < y.size()
