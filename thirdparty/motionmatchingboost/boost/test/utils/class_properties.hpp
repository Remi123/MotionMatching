...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return motionmatchingboost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) motionmatchingboost::unit_test::readwrite_property<property_type >
...
: public motionmatchingboost::unit_test::readonly_property<property_type > {                      \
    typedef motionmatchingboost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return motionmatchingboost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return motionmatchingboost::addressof( base_prop::value ); }
