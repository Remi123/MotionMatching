...
template <typename T, bool is_cstring = is_cstring_impl<typename motionmatchingboost::decay<T>::type>::value >
...
struct deduce_cstring_transform_impl<T, true> {
    typedef typename motionmatchingboost::add_const<
        typename motionmatchingboost::remove_pointer<
            typename motionmatchingboost::decay<T>::type
        >::type
    >::type U;
    typedef motionmatchingboost::unit_test::basic_cstring<U> type;
};

template <typename T>
struct deduce_cstring_transform_impl< T, false > {
    typedef typename
        motionmatchingboost::remove_const<
...
struct deduce_cstring_transform_impl< std::basic_string<T, std::char_traits<T> >, false > {
    typedef motionmatchingboost::unit_test::basic_cstring<typename motionmatchingboost::add_const<T>::type> type;
};
...
public:
    using type = stringview_cstring_helper<typename motionmatchingboost::add_const<T>::type, sv_t>;
};
#endif
...
template<typename T, bool is_cstring = is_cstring<typename motionmatchingboost::decay<T>::type>::value >
...
template<typename T>
struct is_cstring_comparable< motionmatchingboost::unit_test::basic_cstring<T>, false > : public mpl::true_ {};
...
struct deduce_cstring_transform {
    typedef typename
        motionmatchingboost::remove_const<
            typename motionmatchingboost::remove_reference<T>::type
        >::type U;
    typedef typename ut_detail::deduce_cstring_transform_impl<typename motionmatchingboost::decay<U>::type>::type type;
};
