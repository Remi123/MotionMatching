...
inline RefType
deref( static_any_t cur, C&, ::motionmatchingboost::type<RefType>, mpl::false_ )
{
    return *static_any_cast<BOOST_DEDUCED_TYPENAME C::iterator>( cur );
}
...
template<class RefType,typename C>
inline RefType
deref( static_any_t cur, C const&, ::motionmatchingboost::type<RefType>, mpl::true_ )
{
    return *static_any_cast<BOOST_DEDUCED_TYPENAME C::const_iterator>( cur );
}
...
#define BOOST_TEST_FE_ANY                   ::motionmatchingboost::unit_test::for_each::static_any_t
#define BOOST_TEST_FE_IS_CONST( COL )       ::motionmatchingboost::unit_test::for_each::is_const_coll( COL )

#define BOOST_TEST_FE_BEG( COL )            \
    ::motionmatchingboost::unit_test::for_each::begin(    \
        COL,                                \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/

#define BOOST_TEST_FE_END( COL )            \
    ::motionmatchingboost::unit_test::for_each::end(      \
        COL,                                \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/

#define BOOST_TEST_FE_DONE( COL )           \
    ::motionmatchingboost::unit_test::for_each::done(     \
...
#define BOOST_TEST_FE_NEXT( COL )           \
    ::motionmatchingboost::unit_test::for_each::next(     \
        BOOST_TEST_FE_CUR_VAR,              \
        COL,                                \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/
...
#define BOOST_TEST_FE_PREV( COL )           \
    ::motionmatchingboost::unit_test::for_each::prev(     \
        BOOST_TEST_FE_CUR_VAR,              \
        COL,                                \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/
...
#define BOOST_TEST_FE_DEREF( COL, RefType ) \
    ::motionmatchingboost::unit_test::for_each::deref(    \
        BOOST_TEST_FE_CUR_VAR,              \
        COL,                                \
        ::motionmatchingboost::type<RefType >(),          \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/
