...
namespace timer
{
  ...
  typedef motionmatchingboost::int_least64_t nanosecond_type;
...
//  cpu_timer  -------------------------------------------------------------------------//
  ...
  public:
    ...
    std::string   format(short places, const std::string& format) const
                        { return ::motionmatchingboost::timer::format(elapsed(), places, format); }
    std::string   format(short places = default_places) const
                        { return ::motionmatchingboost::timer::format(elapsed(), places); }
    //  actions
