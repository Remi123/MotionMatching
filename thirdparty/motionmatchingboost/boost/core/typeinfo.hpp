...
{
    static motionmatchingboost::core::typeinfo ti_;
...
template<class T> motionmatchingboost::core::typeinfo core_typeid_< T >::ti_( core_typeid_< T >::name(), &core_typeid_lib_id );
...
#define BOOST_CORE_TYPEID(T) (motionmatchingboost::detail::core_typeid_<T>::ti_)
