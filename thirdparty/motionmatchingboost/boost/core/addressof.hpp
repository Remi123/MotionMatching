...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return motionmatchingboost::detail::addrof<T>::get(o, 0);
#else
    return motionmatchingboost::detail::addrof<T>::get(motionmatchingboost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename motionmatchingboost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return motionmatchingboost::detail::addressof(o);
}
#endif
