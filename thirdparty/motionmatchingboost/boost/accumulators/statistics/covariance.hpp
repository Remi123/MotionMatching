...
namespace motionmatchingboost { namespace numeric
{
    ...
    {
        struct outer_product
          : motionmatchingboost::detail::function2<functional::outer_product<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};
    }

    namespace
    {
        op::outer_product const &outer_product = motionmatchingboost::detail::pod_singleton<op::outer_product>::instance;
    }
