...
namespace detail
{
    ...
    struct tail_range
    {
        typedef motionmatchingboost::iterator_range<
            motionmatchingboost::reverse_iterator<motionmatchingboost::permutation_iterator<ElementIterator, IndexIterator> >
        > type;
    };
    ...
    {
        return motionmatchingboost::make_iterator_range(
            motionmatchingboost::make_reverse_iterator(
                motionmatchingboost::make_permutation_iterator(elem_begin, index_end)
            )
          , motionmatchingboost::make_reverse_iterator(
                motionmatchingboost::make_permutation_iterator(elem_begin, index_begin)
            )
        );
    }
...
namespace tag
{
      ...
      , tail_cache_size_named_arg<LeftRight>
    {
        ...
        static motionmatchingboost::parameter::keyword<tail_cache_size_named_arg<LeftRight> > const cache_size;
        #endif
    };
