...
namespace impl
{
    ...
    */
      ...
      : accumulator_base
    {
        ...
        typedef motionmatchingboost::tuple<float_type, float_type, float_type> result_type;
        ...
        weighted_peaks_over_threshold_impl(Args const &args)
          ...
          , fit_parameters_(motionmatchingboost::make_tuple(0., 0., 0.))
          , is_dirty_(true)
        {
        }
        ...
        result_type result(Args const &args) const
        {
            if (this->is_dirty_)
            {
                ...
                this->fit_parameters_ = motionmatchingboost::make_tuple(u_bar, beta_bar, xi_hat);
            }
    ...
    private:
        ...
        mutable result_type fit_parameters_; // motionmatchingboost::tuple that stores fit parameters
            ...
            if (this->is_dirty_)
            {
                ...
                while (sum < threshold)
                {
                    ...
                    else
                    {
                        ...
                        {
                            return motionmatchingboost::make_tuple(
                        ...
                        else
                        {
                            ...
                            motionmatchingboost::throw_exception(std::runtime_error(msg.str()));
                            return motionmatchingboost::make_tuple(Sample(0), Sample(0), Sample(0));
                        }
                    }
                }
