...
namespace impl
{
    ...
    */
    ...
    private:
        ...
        template<typename T>
        void prevent_underflow(T &non_negative_number,typename motionmatchingboost::enable_if<motionmatchingboost::is_arithmetic<T>,T>::type* = 0)
        {
            if (non_negative_number < T(0)) non_negative_number = T(0);
        }
        template<typename T>
        void prevent_underflow(T &non_arithmetic_quantity,typename motionmatchingboost::disable_if<motionmatchingboost::is_arithmetic<T>,T>::type* = 0)
        {
        }
    };
} // namespace impl
...
namespace tag
{
        ...
        : depends_on< rolling_count, rolling_mean, rolling_moment<2> >
    {
        ...
        static motionmatchingboost::parameter::keyword<tag::rolling_window_size> const window_size;
        #endif
    };
