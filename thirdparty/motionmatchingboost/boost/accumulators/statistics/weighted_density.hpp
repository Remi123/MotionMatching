...
namespace tag
{
      ...
      , density_num_bins
    {
        ...
        static motionmatchingboost::parameter::keyword<density_cache_size> const cache_size;
        static motionmatchingboost::parameter::keyword<density_num_bins> const num_bins;
        #endif
    };
}
