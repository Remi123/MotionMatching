...
namespace detail
{
    ///////////////////////////////////////////////////////////////////////////////
    // accumulator_visitor
    //   wrap a motionmatchingboost::parameter argument pack in a Fusion extractor object
  ...
  : detail::accumulator_set_base
{
    ...
    accumulator_set()
      : accumulators(
            detail::make_acc_list(
                accumulators_mpl_vector()
              , (motionmatchingboost::accumulators::accumulator = *this)
            )
        )
    {
        // Add-ref the Features that the user has specified
        this->template visit_if<detail::contains_feature_of_<Features> >(
            detail::make_add_ref_visitor(motionmatchingboost::accumulators::accumulator = *this)
        );
    }
    ...
    explicit accumulator_set(
      ...
      , typename motionmatchingboost::enable_if<
        ...
        >::type = detail::_enabler()
            ...
            detail::make_acc_list(
                accumulators_mpl_vector()
              , (motionmatchingboost::accumulators::accumulator = *this, a1)
            )
        )
    {
        // Add-ref the Features that the user has specified
    ...
    explicit accumulator_set(
        A1 const &a1
      , typename motionmatchingboost::disable_if<
            parameter::is_argument_pack<A1>
          , detail::_enabler
        >::type = detail::_enabler()
    ) : accumulators(
            detail::make_acc_list(
              ...
              , (
                    motionmatchingboost::accumulators::accumulator = *this
                  , motionmatchingboost::accumulators::sample = a1
                )
            )
        )
    {
      ...
      , typename motionmatchingboost::disable_if<                                                     \
        ...
        >::type = detail::_enabler()                                                    \
            ...
            detail::make_acc_list(                                                      \
              ...
              , (                                                                       \
                    motionmatchingboost::accumulators::accumulator = *this                            \
                  , motionmatchingboost::accumulators::sample = BOOST_PP_ENUM_PARAMS_Z(z, n, a)       \
                )                                                                       \
            )                                                                           \
        )                                                                               \
    {                                                                                   \
...
#define BOOST_ACCUMULATORS_ACCUMULATOR_SET_FUN_OP(z, n, _)                              \
    ...
    void drop()
    {
        ...
        (*fusion::find_if<detail::matches_feature<Feature> >(this->accumulators))
            .drop(motionmatchingboost::accumulators::accumulator = *this);
        ...
        this->template visit_if<detail::contains_feature_of_<dependencies> >(
            detail::make_drop_visitor(motionmatchingboost::accumulators::accumulator = *this)
        );
    }
...
extract_result(AccumulatorSet const &acc)
{
    return find_accumulator<Feature>(acc).result(
        motionmatchingboost::accumulators::accumulator = acc
    );
}
