...
namespace detail
{
    ...
    struct accumulator_set_result
    {
        ...
        typedef typename mpl::apply<
            typename motionmatchingboost::remove_const<
                typename motionmatchingboost::remove_reference<AccumulatorSet>::type
            >::type
          , feature_type
    ...
    struct argument_pack_result
      : accumulator_set_result<
            typename motionmatchingboost::remove_reference<
                typename parameter::binding<
                    typename motionmatchingboost::remove_const<
                        typename motionmatchingboost::remove_reference<Args>::type
                    >::type
                  , tag::accumulator
                >::type
            >::type
...
#define BOOST_ACCUMULATORS_DEFINE_EXTRACTOR_FUN_IMPL(z, n, Tag, Feature, ParamsSeq)                 \
    template<                                                                                       \
      ...
      , typename Arg1                                                                               \
        BOOST_PP_ENUM_TRAILING_PARAMS_Z(z, n, typename A)                                           \
    >                                                                                               \
    typename motionmatchingboost::accumulators::detail::extractor_result<                                         \
        Arg1                                                                                        \
    ...
    {                                                                                               \
        ...
        return motionmatchingboost::accumulators::extractor<feature_type>()(                                      \
