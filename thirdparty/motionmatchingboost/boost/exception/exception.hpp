...
#else
namespace motionmatchingboost { template <class T> class shared_ptr; }
...
motionmatchingboost
    ...
    exception_detail
        ...
        motionmatchingboost::source_location get_exception_throw_location( exception const & );
        }
    ...
    exception
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing motionmatchingboost::exception.
        ...
        friend motionmatchingboost::source_location exception_detail::get_exception_throw_location( exception const & );
    ...
    exception_detail
        ...
        inline motionmatchingboost::source_location get_exception_throw_location( exception const & x )
            {
