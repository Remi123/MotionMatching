...
{
   typedef is_polymorphic_selector< ::motionmatchingboost::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::motionmatchingboost::detail::is_polymorphic_imp<T>::value> {};
