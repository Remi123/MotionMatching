...
#pragma GCC system_header
      ...
      template<class T, class U,
         typename motionmatchingboost::make_void<decltype((U*)(std::declval<T*>()))>::type* =
         nullptr>
   ...
   struct is_virtual_base_of : public
      motionmatchingboost::integral_constant<
      bool,
      motionmatchingboost::is_base_of<T, U>::value &&
   ...
   {
      typedef motionmatchingboost::integral_constant<bool, (motionmatchingboost::is_base_of<Base, Derived>::value && !motionmatchingboost::is_same<Base, Derived>::value)> tag_type;
...
template <class Base, class Derived> struct is_virtual_base_of : public integral_constant<bool, (::motionmatchingboost::detail::is_virtual_base_of_impl2<Base, Derived>::value)> {};
