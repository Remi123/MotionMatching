...
{
   BOOST_STATIC_CONSTANT(bool, value = (::motionmatchingboost::detail::is_unsigned_values<T>::minus_one > ::motionmatchingboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::motionmatchingboost::detail::is_unsigned_select_helper< ::motionmatchingboost::is_integral<T>::value || ::motionmatchingboost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, motionmatchingboost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::motionmatchingboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::motionmatchingboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::motionmatchingboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::motionmatchingboost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::motionmatchingboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::motionmatchingboost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::motionmatchingboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::motionmatchingboost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
