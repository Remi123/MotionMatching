...
template <class T> struct is_copy_constructible : public motionmatchingboost::is_constructible<T, const T&>{};
...
// motionmatchingboost::non_copyable as a base class as a special case:
//
...
namespace motionmatchingboost {
   ...
   namespace detail
   {
      ...
      template <class T, bool b> struct is_copy_constructible_imp : public motionmatchingboost::is_constructible<T, const T&>{};
...
namespace motionmatchingboost {
   ...
   namespace detail{
      ...
      struct is_copy_constructible_impl2 {
         ...
         template <class T1>
         static motionmatchingboost::type_traits::yes_type test(const T1&, motionmatchingboost::mpl::int_<sizeof(T1(motionmatchingboost::declval<const T1&>()))>* = 0);
#else
         template <class T1>
         static motionmatchingboost::type_traits::yes_type test(const T1&, decltype(T1(motionmatchingboost::declval<const T1&>()))* = 0);
#endif

         static motionmatchingboost::type_traits::no_type test(...);
#else
         template <class T1>
         static motionmatchingboost::type_traits::no_type test(const T1&, typename T1::boost_move_no_copy_constructor_or_assign* = 0);
         ...
         BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(test(
            motionmatchingboost::declval<BOOST_DEDUCED_TYPENAME motionmatchingboost::add_reference<T const>::type>()
            )) == sizeof(motionmatchingboost::type_traits::yes_type)
            &&
            !motionmatchingboost::is_rvalue_reference<T>::value
            && !motionmatchingboost::is_array<T>::value
            ));
      };
      ...
      struct is_copy_constructible_impl {
         ...
         BOOST_STATIC_CONSTANT(bool, value = (
            motionmatchingboost::detail::is_copy_constructible_impl2<
   ...
   template <class T> struct is_copy_constructible : public integral_constant<bool, ::motionmatchingboost::detail::is_copy_constructible_impl<T>::value>{};
   template <> struct is_copy_constructible<void> : public false_type{};
