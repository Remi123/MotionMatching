...
template<class T, class U> struct is_swappable_with : motionmatchingboost_type_traits_swappable_detail::is_swappable_with_helper<T, U>::type
{
};

template<class T> struct is_swappable : motionmatchingboost_type_traits_swappable_detail::is_swappable_helper<T>::type
{
};
...
template<class T> struct is_swappable
    : motionmatchingboost::conjunction<
        motionmatchingboost::negation< motionmatchingboost::is_const<T> >,
        motionmatchingboost::is_constructible<T, T&&>,
        motionmatchingboost::is_assignable<T&, T&&>
    >::type {};
...
template<class T> struct is_swappable : motionmatchingboost::is_scalar<T> {};
