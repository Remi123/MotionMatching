...
{
template <class T> struct is_nothrow_swappable : motionmatchingboost::integral_constant<bool,
    motionmatchingboost::is_scalar<T>::value && !motionmatchingboost::is_const<T>::value> {};
...
template<class T, class U> struct is_nothrow_swappable_with: motionmatchingboost_type_traits_swappable_detail::is_nothrow_swappable_with_helper<T, U>::type
{
};

template<class T> struct is_nothrow_swappable: motionmatchingboost_type_traits_swappable_detail::is_nothrow_swappable_helper<T>::type
{
};
