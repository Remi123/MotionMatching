...
struct is_empty_impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, 
        value = ( ::motionmatchingboost::detail::empty_helper<cvt,::motionmatchingboost::is_class<T>::value>::value || BOOST_INTERNAL_IS_EMPTY(cvt)));
};
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
              ::motionmatchingboost::detail::empty_helper<
                  cvt
                , ::motionmatchingboost::is_class<T>::value
                , ::motionmatchingboost::is_convertible< r_type,int>::value
...
template <class T> struct is_empty : integral_constant<bool, ::motionmatchingboost::detail::is_empty_impl<T>::value> {};
