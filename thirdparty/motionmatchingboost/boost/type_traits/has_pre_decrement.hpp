...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      /* bool */\
      ::motionmatchingboost::is_same< bool, Rhs_nocv >::value || \
      /* void* */\
      (\
      ...
      (\
         ...
         ::motionmatchingboost::is_const< Rhs_noref >::value\
      )||\
      /* Arrays */ \
      ::motionmatchingboost::is_array<Rhs_noref>::value\
      )
...
namespace motionmatchingboost {
   ...
   template <>
   struct has_pre_decrement<bool, motionmatchingboost::binary_op_detail::dont_care> : public false_type {};
   template <>
