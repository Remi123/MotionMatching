...
#define BOOST_TT_HAS_WORKING_IS_COMPLETE
   ...
   template <class T> struct is_complete
      : public integral_constant<bool, ::motionmatchingboost::is_function<typename motionmatchingboost::remove_reference<T>::type>::value || (sizeof(motionmatchingboost::detail::check_is_complete<T>(0)) != sizeof(char))> {};
   ...
   namespace detail
   {
      ...
      {
         template <class U, class = decltype(sizeof(motionmatchingboost::declval< U >())) >
   ...
   template <class T>
   struct is_complete : motionmatchingboost::integral_constant<bool, ::motionmatchingboost::is_function<typename motionmatchingboost::remove_reference<T>::type>::value || ::motionmatchingboost::detail::is_complete_imp<T>::value>
   {};
   template <class T>
   struct is_complete<T&> : motionmatchingboost::is_complete<T> {};
   
#else

      template <class T> struct is_complete
         : public motionmatchingboost::integral_constant<bool, true> {};
