...
template<class C1, class C2> struct common_member_class
{
    typedef typename motionmatchingboost::conditional<
        ...
        motionmatchingboost::is_base_of<C1, C2>::value,
        C2,
        typename motionmatchingboost::conditional<motionmatchingboost::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename motionmatchingboost::remove_pointer<CPT>::type CT;
