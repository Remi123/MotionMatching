...
struct mp_valid_impl
{
    ...
    static motionmatchingboost::true_type check_s(int);

    template<template<class...> class>
    static motionmatchingboost::false_type check_s(...);
...
template<template<class...> class F, class... T> using mp_defer = typename motionmatchingboost::conditional<mp_valid<F, T...>::value, mp_defer_impl<F, T...>, mp_empty>::type;
