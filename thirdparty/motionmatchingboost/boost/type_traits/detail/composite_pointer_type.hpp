...
private:
    ...
    typedef typename motionmatchingboost::remove_cv<T>::type T2;
    typedef typename motionmatchingboost::remove_cv<U>::type U2;

public:

    BOOST_STATIC_CONSTANT( bool, value =
        (motionmatchingboost::is_same<T2, U2>::value)
        || motionmatchingboost::is_void<T2>::value
        || motionmatchingboost::is_void<U2>::value
        || (motionmatchingboost::is_base_of<T2, U2>::value)
        || (motionmatchingboost::is_base_of<U2, T2>::value) );
};
...
public:
    ...
    typedef typename motionmatchingboost::conditional<
        ...
        motionmatchingboost::is_same<T2, U2>::value || motionmatchingboost::is_void<T2>::value || motionmatchingboost::is_base_of<T2, U2>::value,
        typename motionmatchingboost::copy_cv<T, U>::type,
        typename motionmatchingboost::copy_cv<U, T>::type
...
public:
    ...
    typedef typename motionmatchingboost::copy_cv<typename motionmatchingboost::copy_cv<typename composite_pointer_type<T2, U2>::type const, T>::type, U>::type type;
};

//Old compilers like MSVC-7.1 have problems using motionmatchingboost::conditional in
