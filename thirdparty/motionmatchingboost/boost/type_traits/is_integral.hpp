...
template<> struct is_integral< ::motionmatchingboost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::motionmatchingboost::long_long_type> : public true_type{};
...
template<> struct is_integral<motionmatchingboost::int128_type> : public true_type{};
template<> struct is_integral<motionmatchingboost::uint128_type> : public true_type{};
#endif
