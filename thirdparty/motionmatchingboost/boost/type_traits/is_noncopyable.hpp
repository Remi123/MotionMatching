...
//
//  is_noncopyable<T> returns whether T is derived from motionmatchingboost::noncopyable
//
...
// motionmatchingboost::noncopyable derives from noncopyable_::base_token to enable us
