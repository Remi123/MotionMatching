...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::motionmatchingboost::detail::is_signed_values<T>::minus_one  > motionmatchingboost::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::motionmatchingboost::detail::is_signed_select_helper< ::motionmatchingboost::is_integral<T>::value || ::motionmatchingboost::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, motionmatchingboost::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::motionmatchingboost::long_long_type> : public true_type{};
template <> struct is_signed<const ::motionmatchingboost::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::motionmatchingboost::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::motionmatchingboost::long_long_type> : public true_type{};

template <> struct is_signed< ::motionmatchingboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::motionmatchingboost::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::motionmatchingboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::motionmatchingboost::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
