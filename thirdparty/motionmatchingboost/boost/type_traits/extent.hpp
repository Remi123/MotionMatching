...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::motionmatchingboost::detail::extent_imp<T, N-1>::value));
};
...
}   // ::motionmatchingboost::detail

template <class T, std::size_t N = 0>
struct extent
   : public ::motionmatchingboost::integral_constant<std::size_t, ::motionmatchingboost::detail::extent_imp<T,N>::value>
{
};
