...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename motionmatchingboost::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::motionmatchingboost::is_pointer<T>::value>::type type;
   };
}

template <class T> struct remove_pointer{ typedef typename motionmatchingboost::detail::remove_pointer_imp2<T>::type type; };
