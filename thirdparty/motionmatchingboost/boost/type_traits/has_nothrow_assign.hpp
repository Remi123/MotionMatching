...
namespace motionmatchingboost {
   ...
   namespace detail
   {
      ...
      template <class T>          struct has_nothrow_assign_imp<T, false, true>{ static const bool value = noexcept(motionmatchingboost::declval<typename add_reference<T>::type>() = motionmatchingboost::declval<typename add_reference<T const>::type>()); };
   ...
   struct has_nothrow_assign : public integral_constant < bool,
      ...
      >::value
#else
      ::motionmatchingboost::has_trivial_assign<T>::value
#endif
#else
