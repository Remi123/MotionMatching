...
struct has_nothrow_copy_constructor_imp : public motionmatchingboost::integral_constant<bool, false>{};
template <class T>
struct has_nothrow_copy_constructor_imp<T, true> : public motionmatchingboost::integral_constant<bool, noexcept(T(motionmatchingboost::declval<const T&>()))>{};

}

template <class T> struct has_nothrow_copy_constructor : public detail::has_nothrow_copy_constructor_imp<T, motionmatchingboost::is_copy_constructible<T>::value>{};
...
template <class T> struct has_nothrow_copy_constructor : public integral_constant<bool, ::motionmatchingboost::has_trivial_copy<T>::value>{};
