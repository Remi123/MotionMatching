...
private:
    ...
    motionmatchingboost::system::error_category const * pc_;

public:

    motionmatchingboost::system::error_category const & original_category() const BOOST_NOEXCEPT
    {
        return *pc_;
    }
...
public:
    ...
    explicit std_category( motionmatchingboost::system::error_category const * pc, id_wrapper<Id> ): pc_( pc )
    {
