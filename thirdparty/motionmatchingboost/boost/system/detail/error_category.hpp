...
private:
    ...
    motionmatchingboost::ulong_long_type id_;
...
protected:
    ...
    BOOST_CONSTEXPR
#endif
    error_category( motionmatchingboost::ulong_long_type id ) BOOST_NOEXCEPT: id_( id ), stdcat_(), sc_init_()
    {
    }
...
static const motionmatchingboost::ulong_long_type generic_category_id = ( motionmatchingboost::ulong_long_type( 0xB2AB117A ) << 32 ) + 0x257EDFD0;
static const motionmatchingboost::ulong_long_type system_category_id = generic_category_id + 1;
static const motionmatchingboost::ulong_long_type interop_category_id = generic_category_id + 2;
