...
inline bool std_category::equivalent( int code, const std::error_condition & condition ) const BOOST_NOEXCEPT
{
    ...
    {
        motionmatchingboost::system::error_condition bn( condition.value(), *pc_ );
        return pc_->equivalent( code, bn );
    }
    else if( condition.category() == std::generic_category() || condition.category() == motionmatchingboost::system::generic_category() )
    {
        motionmatchingboost::system::error_condition bn( condition.value(), motionmatchingboost::system::generic_category() );
        return pc_->equivalent( code, bn );
    }
    ...
    {
        motionmatchingboost::system::error_condition bn( condition.value(), *pc2->pc_ );
        return pc_->equivalent( code, bn );
    }
...
inline bool std_category::equivalent( const std::error_code & code, int condition ) const BOOST_NOEXCEPT
{
    ...
    {
        motionmatchingboost::system::error_code bc( code.value(), *pc_ );
        return pc_->equivalent( bc, condition );
    }
    else if( code.category() == std::generic_category() || code.category() == motionmatchingboost::system::generic_category() )
    {
        motionmatchingboost::system::error_code bc( code.value(), motionmatchingboost::system::generic_category() );
        return pc_->equivalent( bc, condition );
    }
    ...
    {
        motionmatchingboost::system::error_code bc( code.value(), *pc2->pc_ );
        return pc_->equivalent( bc, condition );
    }

#endif

    else if( *pc_ == motionmatchingboost::system::generic_category() )
    {
