...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    motionmatchingboost::winapi::FILETIME_ creation, exit, user_time, system_time;

    if ( motionmatchingboost::winapi::GetProcessTimes(
            motionmatchingboost::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        motionmatchingboost::winapi::DWORD_ cause = motionmatchingboost::winapi::GetLastError();
        if (::motionmatchingboost::chrono::is_throws(ec))
        {
            motionmatchingboost::throw_exception(
                    system::system_error(
