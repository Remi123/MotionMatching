  ...
  namespace chrono
  {
    ...
    process_real_cpu_clock::time_point process_real_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        ...
        {
          motionmatchingboost::throw_exception(system::system_error(errno, ::motionmatchingboost::system::system_category(), "chrono::process_real_cpu_clock"));
        } else
        {
          ec.assign(errno, ::motionmatchingboost::system::system_category());
          return time_point();
        }
      } else
      {
    ...
    process_user_cpu_clock::time_point process_user_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::motionmatchingboost::chrono::is_throws(ec))
        {
          motionmatchingboost::throw_exception(system::system_error(errno, ::motionmatchingboost::system::system_category(), "chrono::process_user_cpu_clock"));
        } else
        {
          ec.assign(errno, ::motionmatchingboost::system::system_category());
          return time_point();
    ...
    process_system_cpu_clock::time_point process_system_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::motionmatchingboost::chrono::is_throws(ec))
        {
          motionmatchingboost::throw_exception(system::system_error(errno, ::motionmatchingboost::system::system_category(), "chrono::process_system_cpu_clock"));
        } else
        {
          ec.assign(errno, ::motionmatchingboost::system::system_category());
          return time_point();
    ...
    process_cpu_clock::time_point process_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::motionmatchingboost::chrono::is_throws(ec))
        {
          motionmatchingboost::throw_exception(system::system_error(errno, ::motionmatchingboost::system::system_category(), "chrono::process_clock"));
        } else
        {
          ec.assign(errno, ::motionmatchingboost::system::system_category());
          return time_point();
