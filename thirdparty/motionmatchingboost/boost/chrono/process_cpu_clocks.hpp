...
namespace motionmatchingboost { namespace chrono {
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
    ...
    public:
        ...
        typedef motionmatchingboost::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<motionmatchingboost::chrono::process_times<Rep> >
    {
        typedef motionmatchingboost::chrono::process_times<Rep> Res;
