...
#include <boost/config.hpp>
    ...
    // so we fake it by using motionmatchingboost::has_trivial_construtor.  But this is not
    ...
    template<typename T>
    struct is_default_constructible : public motionmatchingboost::has_trivial_constructor<T> {};
