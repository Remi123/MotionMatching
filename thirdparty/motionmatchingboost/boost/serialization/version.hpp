...
struct version
{
    ...
    typedef
        typename mpl::eval_if<
            is_base_and_derived<motionmatchingboost::serialization::basic_traits,T>,
...
{                                                                      \
    ...
    BOOST_STATIC_CONSTANT(int, value = version::type::value);          \
    BOOST_MPL_ASSERT((                                                 \
        motionmatchingboost::mpl::less<                                              \
            motionmatchingboost::mpl::int_<N>,                                       \
            motionmatchingboost::mpl::int_<256>                                      \
        >                                                              \
    ));                                                                \
    /*                                                                 \
    BOOST_MPL_ASSERT((                                                 \
