...
/**/
    ...
    BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER(motionmatchingboost::long_long_type, C)  \
    BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER(motionmatchingboost::ulong_long_type, C) \
    /**/
#else
    #define BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER_INT64(C)
#endif
