...
namespace motionmatchingboost { namespace serialization {
...
private:
    ...
    friend const motionmatchingboost::serialization::array_wrapper<Tx> make_array(Tx * t, S s);
public:
...
public:
    ...
    void serialize_optimized(Archive &ar, const unsigned int, mpl::false_ ) const
    {
      ...
      T * t = address();
      while(0 < c--)
            ar & motionmatchingboost::serialization::make_nvp("item", *t++);
    }
    ...
    {
      motionmatchingboost::serialization::split_member(ar, *this, version);
    }
...
} } // end namespace motionmatchingboost::serialization
