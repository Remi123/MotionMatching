...
// by specifying friend class motionmatchingboost::serialization::access
...
// i.e. motionmatchingboost::serialization will be searched.
//
...
// 3) motionmatchingboost::serialization
//
// Due to Martin Ecker
