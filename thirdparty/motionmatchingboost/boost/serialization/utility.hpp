...
inline void serialize(
    ...
    typedef typename motionmatchingboost::remove_const<F>::type typef;
    ar & motionmatchingboost::serialization::make_nvp("first", const_cast<typef &>(p.first));
    ar & motionmatchingboost::serialization::make_nvp("second", p.second);
}
