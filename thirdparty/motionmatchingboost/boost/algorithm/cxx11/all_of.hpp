...
namespace motionmatchingboost { namespace algorithm {
...
{
    return motionmatchingboost::algorithm::all_of ( motionmatchingboost::begin (r), motionmatchingboost::end (r), p );
} 
...
{
    return motionmatchingboost::algorithm::all_of_equal ( motionmatchingboost::begin (r), motionmatchingboost::end (r), val );
} 

}} // namespace motionmatchingboost and algorithm
