    ...
    class result_of0
    {
...
#else
        typedef typename ::motionmatchingboost::result_of<F()>::type result_of_F;
#endif
     ...
     public:
        ...
        typedef typename ::motionmatchingboost::mpl::if_<
            ::motionmatchingboost::is_void<result_of_F>
#endif
          , ::motionmatchingboost::parameter::aux::use_default_tag
          , result_of_F
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        >;
#else
