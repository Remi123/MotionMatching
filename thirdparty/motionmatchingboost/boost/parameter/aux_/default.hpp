...
namespace motionmatchingboost { namespace parameter { namespace aux {
    ...
    template <typename KW, typename DefaultComputer>
    struct lazy_default
      : ::motionmatchingboost::parameter::aux::lazy_default_base<KW,DefaultComputer>
    {
        inline BOOST_CONSTEXPR lazy_default(DefaultComputer& x)
          : ::motionmatchingboost::parameter::aux::lazy_default_base<KW,DefaultComputer>(x)
        {
        }
    };
...
#define BOOST_PARAMETER_lazy_default_fallback \
    ::motionmatchingboost::parameter::aux::lazy_default_base
/**/
#else
#define BOOST_PARAMETER_lazy_default_fallback \
    ::motionmatchingboost::parameter::aux::lazy_default
/**/
#endif
