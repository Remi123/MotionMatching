...
namespace motionmatchingboost { namespace parameter { 
    ...
    struct template_keyword : ::motionmatchingboost::parameter::aux::template_keyword_base
    {
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::motionmatchingboost::mp11::mp_eval_if<
        ...
        typedef typename ::motionmatchingboost::mpl::eval_if<
            typename ::motionmatchingboost::mpl::if_<
                ::motionmatchingboost::is_function<value_type>
              , ::motionmatchingboost::mpl::true_
              , ::motionmatchingboost::is_array<value_type>
            >::type
          , ::motionmatchingboost::add_lvalue_reference<value_type>
          , ::motionmatchingboost::mpl::identity<value_type>
        >::type reference;
...
#define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                               \
    ...
    template <typename T>                                                    \
    struct name : ::motionmatchingboost::parameter::template_keyword<tag::name,T>          \
    {                                                                        \
    };
/**/
