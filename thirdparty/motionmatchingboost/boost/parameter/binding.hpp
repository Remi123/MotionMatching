...
namespace motionmatchingboost { namespace parameter { 
    ...
    struct binding0
    {
        ...
        using type = ::motionmatchingboost::mp11::mp_apply_q<
          ...
          , ::motionmatchingboost::mp11::mp_list<Keyword,Default,::motionmatchingboost::mp11::mp_true>
        >;
...
namespace motionmatchingboost { namespace parameter { 
    ...
    struct binding
      ...
      : ::motionmatchingboost::mpl::eval_if<
          ...
          , ::motionmatchingboost::parameter::binding0<Parameters,Keyword,Default>
        >
#endif
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = typename ::motionmatchingboost::mp11::mp_if<
          ...
          , ::motionmatchingboost::mp11::mp_if<
              ...
              , ::motionmatchingboost::parameter::binding1<Parameters,Keyword,Default>
              , ::motionmatchingboost::parameter::binding0<Parameters,Keyword,Default>
            >
        >::type;
#endif
