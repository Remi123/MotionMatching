...
#define BOOST_PARAMETER_NESTED_KEYWORD_AUX(tag_namespace, q, name, alias)    \
    ...
    {                                                                        \
        ...
        {                                                                    \
            ...
            using qualifier = ::motionmatchingboost::parameter::q;                         \
            static ::motionmatchingboost::parameter::keyword<                              \
                BOOST_PP_CAT(name, _)<Dummy>                                 \
            > const& alias;                                                  \
        };                                                                   \
        template <int Dummy>                                                 \
        ::motionmatchingboost::parameter::keyword<                                         \
            BOOST_PP_CAT(name, _)<Dummy>                                     \
...
#define BOOST_PARAMETER_NESTED_KEYWORD_AUX(tag_namespace, q, name, alias)    \
    ...
    {                                                                        \
        ...
        {                                                                    \
            ...
            typedef ::motionmatchingboost::parameter::q qualifier;                         \
            static ::motionmatchingboost::parameter::keyword<                              \
                BOOST_PP_CAT(name, _)<Dummy>                                 \
            > const& alias;                                                  \
        };                                                                   \
