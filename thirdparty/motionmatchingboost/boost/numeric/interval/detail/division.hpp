                                   ...
                                   const interval<T, Policies>& y)
{
  ...
  const T& yl = y.lower();
  const T& yu = y.upper();
  if (::motionmatchingboost::numeric::interval_lib::user::is_neg(xu))
    if (::motionmatchingboost::numeric::interval_lib::user::is_neg(yu))
      return I(rnd.div_down(xu, yl), rnd.div_up(xl, yu), true);
    else
      return I(rnd.div_down(xl, yl), rnd.div_up(xu, yu), true);
  else if (::motionmatchingboost::numeric::interval_lib::user::is_neg(xl))
    if (::motionmatchingboost::numeric::interval_lib::user::is_neg(yu))
...
interval<T, Policies> div_non_zero(const T& x, const interval<T, Policies>& y)
{
  ...
  const T& yl = y.lower();
  const T& yu = y.upper();
  if (::motionmatchingboost::numeric::interval_lib::user::is_neg(x))
...
{
  // assert(::motionmatchingboost::numeric::interval_lib::user::is_pos(yu));
  if (::motionmatchingboost::numeric::interval_lib::user::is_zero(x.lower()) &&
      ::motionmatchingboost::numeric::interval_lib::user::is_zero(x.upper()))
    return x;
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  const T& xl = x.lower();
...
interval<T, Policies> div_positive(const T& x, const T& yu)
{
  // assert(::motionmatchingboost::numeric::interval_lib::user::is_pos(yu));
  typedef interval<T, Policies> I;
  if (::motionmatchingboost::numeric::interval_lib::user::is_zero(x))
...
{
  // assert(::motionmatchingboost::numeric::interval_lib::user::is_neg(yl));
  if (::motionmatchingboost::numeric::interval_lib::user::is_zero(x.lower()) &&
      ::motionmatchingboost::numeric::interval_lib::user::is_zero(x.upper()))
    return x;
  typename Policies::rounding rnd;
...
{
  // assert(::motionmatchingboost::numeric::interval_lib::user::is_neg(y.lower()) && ::motionmatchingboost::numeric::interval_lib::user::is_pos(y.upper()));
  if (::motionmatchingboost::numeric::interval_lib::user::is_zero(x.lower()) && ::motionmatchingboost::numeric::interval_lib::user::is_zero(x.upper()))
    { b = false; return x; }
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  const T& xl = x.lower();
...
interval<T, Policies> div_zero_part2(const interval<T, Policies>& x,
                                     const interval<T, Policies>& y)
{
  // assert(::motionmatchingboost::numeric::interval_lib::user::is_neg(y.lower()) && ::motionmatchingboost::numeric::interval_lib::user::is_pos(y.upper()) && (div_zero_part1(x, y, b), b));
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  typedef typename Policies::checking checking;
  if (::motionmatchingboost::numeric::interval_lib::user::is_neg(x.upper()))
