...
namespace motionmatchingboost { namespace numeric { namespace convdetail
{
  // Integral Constants for 'UdtMixture'
  typedef motionmatchingboost::integral_constant<udt_builtin_mixture_enum, builtin_to_builtin> builtin2builtin_c ;
  typedef motionmatchingboost::integral_constant<udt_builtin_mixture_enum, builtin_to_udt>     builtin2udt_c ;
  typedef motionmatchingboost::integral_constant<udt_builtin_mixture_enum, udt_to_builtin>     udt2builtin_c ;
  typedef motionmatchingboost::integral_constant<udt_builtin_mixture_enum, udt_to_udt>         udt2udt_c ;
...
} } } // namespace motionmatchingboost::numeric::convdetail
