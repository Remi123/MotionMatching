...
namespace motionmatchingboost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(motionmatchingboost::long_long_type)(motionmatchingboost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (motionmatchingboost::long_long_type)(motionmatchingboost::ulong_long_type)
