...
namespace {
  template<class T>
    typename motionmatchingboost::mpl::if_c<motionmatchingboost::is_integral<T>::value,
                              double,
                              T>::type
...
template<typename T>
inline typename motionmatchingboost::disable_if<
    motionmatchingboost::is_unsigned<T>, T >::type
...
template<typename T>
inline typename motionmatchingboost::enable_if<
    motionmatchingboost::is_unsigned<T>, T >::type
    boost_numeric_ublas_abs (const T &t ) {
        return t;
    }
...
namespace motionmatchingboost { namespace numeric { namespace ublas {


    template<typename R, typename I>
    typename motionmatchingboost::enable_if<
      mpl::and_<
        motionmatchingboost::is_float<R>,
        motionmatchingboost::is_integral<I>
        >,
    ...
    template<>
    struct type_traits<motionmatchingboost::numeric::interval<float> > : scalar_traits<motionmatchingboost::numeric::interval<float> > {
        typedef type_traits<motionmatchingboost::numeric::interval<float> > self_type;
        typedef motionmatchingboost::numeric::interval<float> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef motionmatchingboost::numeric::interval<double> precision_type;

    };
    template<>
    struct type_traits<motionmatchingboost::numeric::interval<double> > : scalar_traits<motionmatchingboost::numeric::interval<double> > {
        typedef type_traits<motionmatchingboost::numeric::interval<double> > self_type;
        typedef motionmatchingboost::numeric::interval<double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef motionmatchingboost::numeric::interval<long double> precision_type;
    };
    template<>
    struct type_traits<motionmatchingboost::numeric::interval<long double> > : scalar_traits<motionmatchingboost::numeric::interval<long double> > {
        typedef type_traits<motionmatchingboost::numeric::interval<long double> > self_type;
        typedef motionmatchingboost::numeric::interval<long double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef value_type precision_type;
    ...
    namespace detail {
        ...
        template<typename T>
        struct has_trivial_constructor : public motionmatchingboost::has_trivial_constructor<T> {};

        template<typename T>
        struct has_trivial_destructor : public motionmatchingboost::has_trivial_destructor<T> {};
