...
namespace aabb
{
    ...
    public:
         ...
         */
        AABB(const std::vector<float>&, const std::vector<float>&);
         ...
         */
        std::vector<float> computeCentre();
    ...
    public:
         ...
         */
        Tree(unsigned int dimension_= 3, float skinThickness_ = 0.05,
        ...
        /*! \param dimension_
            ...
            \param touchIsOverlap
                Does touching count as overlapping in query operations?
         */
        Tree(unsigned int, float, const std::vector<bool>&, const std::vector<float>&,
            unsigned int nParticles = 16, bool touchIsOverlap=true);
         ...
         */
        void insertParticle(unsigned int, std::vector<float>&, float);
        ...
        /*! \param index
            ...
            \param upperBound
                The upper bound in each dimension.
         */
        void insertParticle(unsigned int, std::vector<float>&, std::vector<float>&);
         ...
         */
        bool updateParticle(unsigned int, std::vector<float>&, float, bool alwaysReinsert=false);
        ...
        /*! \param particle
            ...
            \param alwaysReinsert
                Always reinsert the particle, even if it's within its old AABB (default: false)
         */
        bool updateParticle(unsigned int, std::vector<float>&, std::vector<float>&, bool alwaysReinsert=false);
    ...
    private:
         ...
         */
        bool minimumImage(std::vector<float>&, std::vector<float>&);
    };
}
