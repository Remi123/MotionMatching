...
struct IKLookAt3D : godot::Node3D
{
    GDCLASS(IKLookAt3D,Node3D);
    ...
    {
        ClassDB::bind_method( D_METHOD("set_active" ,"value"), &IKLookAt3D::set_active); 
        ClassDB::bind_method( D_METHOD("get_active" ), &IKLookAt3D::get_active); 
        godot::ClassDB::add_property(get_class_static(), PropertyInfo(Variant::BOOL,"active"), "set_active", "get_active");

        ClassDB::bind_method( D_METHOD("set_bone" ,"value"), &IKLookAt3D::set_bone); 
        ClassDB::bind_method( D_METHOD("get_bone" ), &IKLookAt3D::get_bone); 
        godot::ClassDB::add_property(get_class_static(), PropertyInfo(Variant::STRING,"bone"), "set_bone", "get_bone");

        ClassDB::bind_method( D_METHOD("set_mixer" ,"value"), &IKLookAt3D::set_mixer); 
        ClassDB::bind_method( D_METHOD("get_mixer" ), &IKLookAt3D::get_mixer); 
        ...
        ClassDB::bind_method( D_METHOD("set_skeleton" ,"value"), &IKLookAt3D::set_skeleton); 
        ClassDB::bind_method( D_METHOD("get_skeleton" ), &IKLookAt3D::get_skeleton); 
